...
public interface IPost {
    @FormUrlEncoded
    @POST("user/register")
    Call<IsRegister> registerData(@Field("username")String username, @Field("password")String password,@Field("nickname")String nickname,@Field("userEmail")String userEmail,@Field("checkCode")String checkCode);
